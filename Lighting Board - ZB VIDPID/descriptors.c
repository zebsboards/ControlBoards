...
#define USB_STRING_TABLE(_map_) \
	...
	_map_(ProductString_id,       "ZB Lighting Board DEV1") \
	_map_(SerialNumString_id,       "ZB0000LOBD1") \
	// sn:ZB0000LOBD1  man:ZB Lighting Board DEV1  sn: ZB000024PD2  man: ZB 24Port DEV2
