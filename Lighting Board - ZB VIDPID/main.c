...
#define LED_MAPPING_TABLE(_map_) \
	...
	\
	_map_( E, 6, 0 ) /* Digital Pin 1  Output 1*/ \
	_map_( B, 0, 0 ) /* Digital Pin 12 Output 2*/ \
	_map_( B, 1, 0 ) /* Digital Pin 13 Output 3*/ \
	_map_( B, 2, 0 ) /* Analog Pin 4   Output 4*/ \
	_map_( B, 3, 0 ) /* Analog Pin 5   Output 5*/ \
	\
	_map_( F, 0, 0 ) /* Digital Pin 0 Output 6*/ \
	_map_( F, 1, 0 ) /* Digital Pin 1 Output 7*/ \
	_map_( F, 4, 0 ) /* Digital Pin 2 Output 8*/ \
	_map_( F, 5, 0 ) /* Digital Pin 3 Output 9*/ \
	_map_( F, 6, 0 ) /* Digital Pin 4 Output 10*/ \
	_map_( F, 7, 0 ) /* Digital Pin 5 Output 11*/ \
	_map_( C, 7, 0 ) /* Digital Pin 6 Output 12*/ \
	_map_( C, 6, 0 ) /* Digital Pin 7 Output 13*/ \
	_map_( B, 6, 0 ) /* Digital Pin 8 Output 14*/ \
	_map_( B, 5, 0 ) /* Digital Pin 9 Output 15*/ \
	...
	_map_( D, 5, 0 ) /* Digital Pin 10 Output 16*/ \
	_map_( D, 3, 0 ) /* Digital Pin 10 Output 16*/ \
	_map_( D, 2, 0 ) /* Digital Pin 10 Output 16*/ \
	_map_( D, 1, 0 ) /* Digital Pin 10 Output 16*/ \
