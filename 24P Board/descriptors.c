...
#define USB_VENDOR_ID      0x20A0
#define USB_PRODUCT_ID     0x00F1   // this is used as the device identifier, 0x00F0 is '1' up to 0x00FF is '16'
#define USB_VERSION_BCD    VERSION_BCD(01.10)

#define USB_STRING_TABLE(_map_) \
	_map_(ManufacturerString_id,  "Zebsboards.com") \
	_map_(ProductString_id,       "ZB 24Port DEV2") \
	_map_(SerialNumString_id,       "ZBV1R2024PD2") \
	// sn:ZBV1R2LOBD1  man:ZB Lighting Board DEV1  sn: ZB000024PD2  man: ZB 24Port DEV2
...
//	.ReleaseNumber          = USB_VERSION_BCD,
	...
	.SerialNumStrIndex      = SerialNumString_id,
